                    ...
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <c:forEach items="${responseDTO.dtoList}" var="dto">
                                <tr>
                                    ...
                                    <td>
                                        <a href="/todo/read?tno=${dto.tno}&link=${pageRequestDTO.link}"
                        ...
                        <script>
                            ...
                            document.querySelector(".pagination").addEventListener("click", function (e) {
                                ...
                                self.location = `/todo/list?page=\${num}&${pageRequestDTO.link}` //백틱(` `)을 이용해서 템플릿 처리
                            }, false)
